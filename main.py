...
def do_request(api_key,subject,n_words,article_type,other_needs):
    r=requests.request(
        method="POST",
...
def main():
    ...
    print("AI生成中...")
    try:
        print(do_request(api_key,subject,n_words,article_type,other_needs)['choices'][0]['message']['content'])
    except:
